    ...
    <header className="bg-cream text-choco border-b border-choco sticky top-0 z-50">
      <div className="container-max-w-5xl bg-cream flex justify-between items-center h-16 relative">
        ...
        <nav className="hidden sm:flex space-x-6">
          ...
          <a href="#services" className="hover:text-mint">
            Services
          </a>
          <a href="#clients" className="hover:text-vitamin">
            Clients
          </a>
          <a href="#contact" className="hover:text-vitamin">
            Contact
          </a>
        </nav>
      </div>
      ...
      >
        <nav className="flex flex-col items-center pt-20 pb-5">
          <a
            href="#about"
            className={`block px-4 py-2 hover:bg-mint w-full text-center transform transition duration-300 hover:text-cream ${
              isOpen ? "animate-scale-up-and-shake" : ""
            }`}
          >
            About
          </a>
          ...
          <a
            href="#clients"
            className={`block px-4 py-2 hover:bg-vitamin w-full text-center transform transition duration-300 hover:text-cream ${
              isOpen ? "animate-scale-up-and-shake" : ""
            }`}
          >
            Clients
